/*
 * This is the SPike-Trap. Mostly based on the single door and LED work that was done, but with the spikes sped up.
 * 
 * This work is based on the Servo for ESP8266 and the IRremoteESP8266: IRrecvDemo 
 * 
 * Dafydd Roche - 1/1/2022
 * 
...
void loop() {
  ...
  int pos;
    ...
    case 1:    // GATE 1 Down
      ...
      trapOne.write(0);              // tell servo to go to position in variable 'pos'
