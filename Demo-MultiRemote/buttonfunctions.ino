...
void buttonONE() // toggle motor #1.
{
    ...
    case 0:    // RESET THE TRAP
      Serial.println("OPEN ");
      for (trapOnePos = 0; trapOnePos <= 180; trapOnePos += 1) { // goes from 0 degrees to 180 degrees
    ...
    case 1:    // GATE 1 Down
      ...
      for (trapOnePos = 180; trapOnePos >= 0; trapOnePos -= 1) { // goes from 180 degrees to 0 degrees
      trapOne.write(trapOnePos);              // tell servo to go to trapOnePosition in variable 'trapOnePos'
      delay(25); }                       // waits 15ms for the servo to reach the trapOnePosition
      break;
      }
...
void buttonTWO() // toggle motor #2.
{
    ...
    case 0:    // RESET THE TRAP
      Serial.println("OPEN ");
      for (trapTwoPos = 0; trapTwoPos <= 180; trapTwoPos += 1) { // goes from 0 degrees to 180 degrees
    // in steps of 1 degree
    ...
    case 1:    // GATE 1 Down
      Serial.println("CLOSED ");
      for (trapTwoPos = 180; trapTwoPos >= 0; trapTwoPos -= 1) { // goes from 180 degrees to 0 degrees
